        ...
        {projects.map((project, index) => (
          <div key={project.key} className="mx mb-3 md:mb-4 2xl:mb-5">
            <button
              ...
              className="font font-panchang dark:text-mainWhite text-left text-sm hover:cursor-pointer hover:text-gray-500 dark:hover:text-gray-300 sm:text-base"
            >
              {project.name}
            </button>
            <AnimatePresence>
              {activeIndex === index && (
                ...
                >
                  ...
                  >
                    <div className="font-chillax sm:max-w-105 lg:my-auto lg:h-fit">
                      ...
                      <div className="mb-2 flex flex-row">
                        <div className="lg:hidden">
                          {project.tags.map(({ key, name, icon: Icon }) => (
                            ...
                            >
                              {name} <Icon className="ml-px inline-block" />
                            </span>
                          ))}
                        </div>
                    ...
                    <img
                      ...
                      className="max-w-[375 dark:border-mainWhite my-auto border border-black sm:max-w-105"
                      src={project.img}
                      loading="lazy
                      "
                    />
